...
return static function (RouteBuilder $routes) {
    return function (RouteBuilder $routes) {
        ...
        $routes->scope('/', ['controller' => 'Articles'], function (RouteBuilder $builder) {
            ...
            $builder->connect('/add-comment', ['action' => 'addComment']);
        ...
        $routes->scope('/archive', ['controller' => 'Articles', 'action' => 'archive'], function (RouteBuilder $builder) {
